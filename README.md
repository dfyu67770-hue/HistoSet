...
The current GitHub release target is `v1.1.3`: https://github.com/dfyu67770-hue/HistoSet/releases/tag/v1.1.3. After Zenodo archiving is completed, the Zenodo DOI should be added to the Data and Code Availability statement, `CITATION.cff`, and this README.
